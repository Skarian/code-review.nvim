...
function M.show_help()
  return ui.open_composer_help({
    ...
    "",
    "Overview",
    "  Draft comments have File References and comment text",
    "  References are read-only rows; the comment box is the editable buffer",
    "  Press Tab or Shift-Tab to move between references and comment text",
    "",
    "References",
    "  Key          Action",
