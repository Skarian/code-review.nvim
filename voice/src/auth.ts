...
export function candidateAuthFiles(env: any = process.env) {
...
function classify(raw: string, file: string, nowSeconds: number): any {
  let parsed;
  try {
...
export async function discoverCredentials(options: any = {}): Promise<any> {
